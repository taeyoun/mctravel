...
import DropdownTrigger from './dropdwon-trigger';
import DropdownContent from './dropdown-content';

class DropdownOrginal extends Component {
    displayName: 'DropdownOrginal'
...
DropdownOrginal.defaultProps = {
    className: ''
};

export { DropdownTrigger, DropdownContent };
export default DropdownOrginal;